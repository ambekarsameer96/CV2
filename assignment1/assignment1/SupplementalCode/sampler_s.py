...
def subsample_from_source_by_density(source):
    #sub-sampling from source by density
    #find nearest neighbors
    tree = KDTree(source)
    nearest_dist, nearest_ind = tree.query(source, k=3)
    #give list of indicces with good amount of neigbors, such that the density is high. 
    return source[nearest_ind]
